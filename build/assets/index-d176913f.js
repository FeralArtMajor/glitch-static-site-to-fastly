(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const l of i)if(l.type==="childList")for(const r of l.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function n(i){const l={};return i.integrity&&(l.integrity=i.integrity),i.referrerPolicy&&(l.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?l.credentials="include":i.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function s(i){if(i.ep)return;i.ep=!0;const l=n(i);fetch(i.href,l)}})();/*! (c) Andrea Giammarchi - ISC */var S={};try{S.WeakMap=WeakMap}catch{S.WeakMap=function(e,n){var s=n.defineProperty,i=n.hasOwnProperty,l=r.prototype;return l.delete=function(a){return this.has(a)&&delete a[this._]},l.get=function(a){return this.has(a)?a[this._]:void 0},l.has=function(a){return i.call(a,this._)},l.set=function(a,o){return s(a,this._,{configurable:!0,value:o}),this},r;function r(a){s(this,"_",{value:"_@ungap/weakmap"+e++}),a&&a.forEach(c,this)}function c(a){this.set(a[0],a[1])}}(Math.random(),Object)}const N=S.WeakMap;/*! (c) Andrea Giammarchi - ISC */var m="-"+Math.random().toFixed(6)+"%",O=!1;try{(function(t,e,n){return e in t&&(t.innerHTML="<p "+n+'="'+m+'"></p>',t[e].childNodes[0].getAttribute(n)==m)})(document.createElement("template"),"content","tabindex")||(m="_dt: "+m.slice(1,-1)+";",O=!0)}catch{}var Z="<!--"+m+"-->",a1=8,l1=1,c1=3,I=/^(?:plaintext|script|style|textarea|title|xmp)$/i,o1=/^(?:area|base|br|col|embed|hr|img|input|keygen|link|menuitem|meta|param|source|track|wbr)$/i;/*! (c) Andrea Giammarchi - ISC */function C1(t){return t.join(Z).replace(u1,g1).replace(f1,v1)}var A=" \\f\\n\\r\\t",q="[^"+A+`\\/>"'=]+`,$="["+A+"]+"+q,K="<([A-Za-z]+[A-Za-z0-9:._-]*)((?:",X=`(?:\\s*=\\s*(?:'[^']*?'|"[^"]*?"|<[^>]*?>|`+q.replace("\\/","")+"))?)",f1=new RegExp(K+$+X+"+)(["+A+"]*/?>)","g"),u1=new RegExp(K+$+X+"*)(["+A+"]*/>)","g"),h1=new RegExp("("+$+`\\s*=\\s*)(['"]?)`+Z+"\\2","gi");function v1(t,e,n,s){return"<"+e+n.replace(h1,p1)+s}function p1(t,e,n){return e+(n||'"')+m+(n||'"')}function g1(t,e,n){return o1.test(e)?t:"<"+e+n+"></"+e+">"}const{isArray:H}=Array,{indexOf:l2,slice:L}=[],V=t=>({get:e=>t.get(e),set:(e,n)=>(t.set(e,n),n)}),m1=1,J=111,w1=({firstChild:t,lastChild:e})=>{const n=document.createRange();return n.setStartAfter(t),n.setEndAfter(e),n.deleteContents(),t},M=(t,e)=>t.nodeType===J?1/e<0?e?w1(t):t.lastChild:e?t.valueOf():t.firstChild:t,d1=t=>{const{childNodes:e}=t,{length:n}=e;if(n<2)return n?e[0]:t;const s=L.call(e,0),i=s[0],l=s[n-1];return{ELEMENT_NODE:m1,nodeType:J,firstChild:i,lastChild:l,valueOf(){if(e.length!==n){let r=0;for(;r<n;)t.appendChild(s[r++])}return t}}};/*! (c) Andrea Giammarchi - ISC */var Y=function(t){var e="fragment",n="template",s="content"in r(n),i=s?function(a){var o=r(n);return o.innerHTML=a,o.content}:function(a){var o=r(e),C=r(n),u=null;if(/^[^\S]*?<(col(?:group)?|t(?:head|body|foot|r|d|h))/i.test(a)){var h=RegExp.$1;C.innerHTML="<table>"+a+"</table>",u=C.querySelectorAll(h)}else C.innerHTML=a,u=C.childNodes;return l(o,u),o};return function(o,C){return(C==="svg"?c:i)(o)};function l(a,o){for(var C=o.length;C--;)a.appendChild(o[0])}function r(a){return a===e?t.createDocumentFragment():t.createElementNS("http://www.w3.org/1999/xhtml",a)}function c(a){var o=r(e),C=r("div");return C.innerHTML='<svg xmlns="http://www.w3.org/2000/svg">'+a+"</svg>",l(o,C.firstChild.childNodes),o}}(document);const k=(t,e,n,s,i)=>{const l=n.length;let r=e.length,c=l,a=0,o=0,C=null;for(;a<r||o<c;)if(r===a){const u=c<l?o?s(n[o-1],-0).nextSibling:s(n[c-o],0):i;for(;o<c;)t.insertBefore(s(n[o++],1),u)}else if(c===o)for(;a<r;)(!C||!C.has(e[a]))&&t.removeChild(s(e[a],-1)),a++;else if(e[a]===n[o])a++,o++;else if(e[r-1]===n[c-1])r--,c--;else if(e[a]===n[c-1]&&n[o]===e[r-1]){const u=s(e[--r],-1).nextSibling;t.insertBefore(s(n[o++],1),s(e[a++],-1).nextSibling),t.insertBefore(s(n[--c],1),u),e[r]=n[c]}else{if(!C){C=new Map;let u=o;for(;u<c;)C.set(n[u],u++)}if(C.has(e[a])){const u=C.get(e[a]);if(o<u&&u<c){let h=a,p=1;for(;++h<r&&h<c&&C.get(e[h])===u+p;)p++;if(p>u-o){const v=s(e[a],0);for(;o<u;)t.insertBefore(s(n[o++],1),v)}else t.replaceChild(s(n[o++],1),s(e[a++],-1))}else a++}else t.removeChild(s(e[a++],-1))}return n};/*! (c) Andrea Giammarchi - ISC */var x1=function(t,e,n,s,i){var l=i in t,r=t.createDocumentFragment();r[e](t[s]("g")),r[e](t[s](""));var c=l?t[i](r,!0):r[n](!0);return c.childNodes.length<2?function a(o,C){for(var u=o[n](),h=o.childNodes||[],p=h.length,v=0;C&&v<p;v++)u[e](a(h[v],C));return u}:l?t[i]:function(a,o){return a[n](!!o)}}(document,"appendChild","cloneNode","createTextNode","importNode"),Q="".trim||function(){return String(this).replace(/^\s+|\s+/g,"")},b1=O?function(t,e){var n=e.join(" ");return e.slice.call(t,0).sort(function(s,i){return n.indexOf(s.name)<=n.indexOf(i.name)?-1:1})}:function(t,e){return e.slice.call(t,0)};function y1(t,e){for(var n=e.length,s=0;s<n;)t=t.childNodes[e[s++]];return t}function t1(t,e,n,s){for(var i=t.childNodes,l=i.length,r=0;r<l;){var c=i[r];switch(c.nodeType){case l1:var a=s.concat(r);M1(c,e,n,a),t1(c,e,n,a);break;case a1:var o=c.textContent;if(o===m)n.shift(),e.push(I.test(t.nodeName)?j(t,s):k1(c,s.concat(r)));else switch(o.slice(0,2)){case"/*":if(o.slice(-2)!=="*/")break;case"👻":t.removeChild(c),r--,l--}break;case c1:I.test(t.nodeName)&&Q.call(c.textContent)===Z&&(n.shift(),e.push(j(t,s)));break}r++}}function M1(t,e,n,s){for(var i=t.attributes,l=[],r=[],c=b1(i,n),a=c.length,o=0;o<a;){var C=c[o++],u=C.value===m,h;if(u||1<(h=C.value.split(Z)).length){var p=C.name;if(l.indexOf(p)<0){l.push(p);var v=n.shift().replace(u?/^(?:|[\S\s]*?\s)(\S+?)\s*=\s*('|")?$/:new RegExp("^(?:|[\\S\\s]*?\\s)("+p+`)\\s*=\\s*('|")[\\S\\s]*`,"i"),"$1"),d=i[v]||i[v.toLowerCase()];if(u)e.push(P(d,s,v,null));else{for(var x=h.length-2;x--;)n.shift();e.push(P(d,s,v,h))}}r.push(C)}}a=r.length,o=0;for(var E=0<a&&O&&!("ownerSVGElement"in t);o<a;){var w=r[o++];E&&(w.value=""),t.removeAttribute(w.name)}var b=t.nodeName;if(/^script$/i.test(b)){var y=document.createElement(b);for(a=i.length,o=0;o<a;)y.setAttributeNode(i[o++].cloneNode(!0));y.textContent=t.textContent,t.parentNode.replaceChild(y,t)}}function k1(t,e){return{type:"any",node:t,path:e}}function P(t,e,n,s){return{type:"attr",node:t,path:e,name:n,sparse:s}}function j(t,e){return{type:"text",node:t,path:e}}var R=V(new N);function L1(t,e){var n=(t.convert||C1)(e),s=t.transform;s&&(n=s(n));var i=Y(n,t.type);e1(i);var l=[];return t1(i,l,e.slice(0),[]),{content:i,updates:function(r){for(var c=[],a=l.length,o=0,C=0;o<a;){var u=l[o++],h=y1(r,u.path);switch(u.type){case"any":c.push({fn:t.any(h,[]),sparse:!1});break;case"attr":var p=u.sparse,v=t.attribute(h,u.name,u.node);p===null?c.push({fn:v,sparse:!1}):(C+=p.length-2,c.push({fn:v,sparse:!0,values:p}));break;case"text":c.push({fn:t.text(h),sparse:!1}),h.textContent="";break}}return a+=C,function(){var d=arguments.length;if(a!==d-1)throw new Error(d-1+" values instead of "+a+`
`+e.join("${value}"));for(var x=1,E=1;x<d;){var w=c[x-E];if(w.sparse){var b=w.values,y=b[0],D=1,_=b.length;for(E+=_-2;D<_;)y+=arguments[x++]+b[D++];w.fn(y)}else w.fn(arguments[x++])}return r}}}}function T1(t,e){var n=R.get(e)||R.set(e,L1(t,e));return n.updates(x1.call(document,n.content,!0))}var E1=[];function H1(t){var e=E1,n=e1;return function(s){return e!==s&&(n=T1(t,e=s)),n.apply(null,arguments)}}function e1(t){for(var e=t.childNodes,n=e.length;n--;){var s=e[n];s.nodeType!==1&&Q.call(s.textContent).length===0&&t.removeChild(s)}}/*! (c) Andrea Giammarchi - ISC */var z1=function(){var t=/acit|ex(?:s|g|n|p|$)|rph|ows|mnc|ntw|ine[ch]|zoo|^ord/i,e=/([^A-Z])([A-Z]+)/g;return function(c,a){return"ownerSVGElement"in c?s(c,a):l(c.style,!1)};function n(r,c,a){return c+"-"+a.toLowerCase()}function s(r,c){var a;return c?a=c.cloneNode(!0):(r.setAttribute("style","--hyper:style;"),a=r.getAttributeNode("style")),a.value="",r.setAttributeNode(a),l(a,!0)}function i(r){var c,a=[];for(c in r)a.push(c.replace(e,n),":",r[c],";");return a.join("")}function l(r,c){var a,o;return function(C){var u,h,p,v;switch(typeof C){case"object":if(C){if(a==="object"){if(!c&&o!==C)for(h in o)h in C||(r[h]="")}else c?r.value="":r.cssText="";u=c?{}:r;for(h in C)v=C[h],p=typeof v=="number"&&!t.test(h)?v+"px":v,!c&&/^--/.test(h)?u.setProperty(h,p):u[h]=p;a="object",c?r.value=i(o=u):o=C;break}default:o!=C&&(a="string",o=C,c?r.value=C||"":r.cssText=C||"");break}}}}();const Z1=t=>e=>{for(const n in e){const s=n==="role"?n:`aria-${n}`,i=e[n];i==null?t.removeAttribute(s):t.setAttribute(s,i)}},F=(t,e)=>{let n,s=!0;const i=document.createAttributeNS(null,e);return l=>{n!==l&&(n=l,n==null?s||(t.removeAttributeNode(i),s=!0):(i.value=l,s&&(t.setAttributeNodeNS(i),s=!1)))}},A1=(t,e,n)=>s=>{n!==!!s&&((n=!!s)?t.setAttribute(e,""):t.removeAttribute(e))},n1=({dataset:t})=>e=>{for(const n in e){const s=e[n];s==null?delete t[n]:t[n]=s}},B1=(t,e)=>{let n,s=e.slice(2);return!(e in t)&&e.toLowerCase()in t&&(s=s.toLowerCase()),i=>{const l=H(i)?i:[i,!1];n!==l[0]&&(n&&t.removeEventListener(s,n,l[1]),(n=l[0])&&t.addEventListener(s,n,l[1]))}},S1=t=>e=>{typeof e=="function"?e(t):e.current=t},W=(t,e)=>e==="dataset"?n1(t):n=>{t[e]=n},N1=(t,e)=>{let n;return s=>{n!==s&&(n=s,t[e]!==s&&(s==null?(t[e]="",t.removeAttribute(e)):t[e]=s))}},O1=/^(?:form|list)$/i,$1=(t,e)=>t.ownerDocument.createTextNode(e);function s1(t){return this.type=t,H1(this)}s1.prototype={attribute(t,e,n){const s=this.type==="svg";switch(e){case"class":if(s)return F(t,e);e="className";case"props":return W(t,e);case"aria":return Z1(t);case"style":return z1(t,n,s);case"ref":return S1(t);case".dataset":return n1(t);default:return e.slice(0,1)==="."?W(t,e.slice(1)):e.slice(0,1)==="?"?A1(t,e.slice(1)):e.slice(0,2)==="on"?B1(t,e):e in t&&!(s||O1.test(e))?N1(t,e):F(t,e)}},any(t,e){const{type:n}=this;let s=!1,i;const l=r=>{switch(typeof r){case"string":case"number":case"boolean":s?i!==r&&(i=r,e[0].textContent=r):(s=!0,i=r,e=k(t.parentNode,e,[$1(t,r)],M,t));break;case"function":l(r(t));break;case"object":case"undefined":if(r==null){s=!1,e=k(t.parentNode,e,[],M,t);break}default:if(s=!1,i=r,H(r))if(r.length===0)e.length&&(e=k(t.parentNode,e,[],M,t));else switch(typeof r[0]){case"string":case"number":case"boolean":l(String(r));break;case"function":l(r.map(V1,t));break;case"object":H(r[0])&&(r=r.concat.apply([],r));default:e=k(t.parentNode,e,r,M,t);break}else"ELEMENT_NODE"in r?e=k(t.parentNode,e,r.nodeType===11?L.call(r.childNodes):[r],M,t):"text"in r?l(String(r.text)):"any"in r?l(r.any):"html"in r?e=k(t.parentNode,e,L.call(Y([].concat(r.html).join(""),n).childNodes),M,t):"length"in r&&l(L.call(r));break}};return l},text(t){let e;const n=s=>{if(e!==s){e=s;const i=typeof s;i==="object"&&s?"text"in s?n(String(s.text)):"any"in s?n(s.any):"html"in s?n([].concat(s.html).join("")):"length"in s&&n(L.call(s).join("")):i==="function"?n(s(t)):t.textContent=s??""}};return n}};function V1(t){return t(this)}const{create:D1,freeze:_1,keys:c2}=Object,G=V(new N),I1=t=>({html:U("html",t),svg:U("svg",t),render(e,n){const s=typeof n=="function"?n():n,i=G.get(e)||G.set(e,T()),l=s instanceof B?z(t,i,s):s;return l!==i.wire&&(i.wire=l,e.textContent="",e.appendChild(l.valueOf())),e}}),T=()=>({stack:[],entry:null,wire:null}),U=(t,e)=>{const n=V(new N),s=l=>function(){return z(e,l,i.apply(null,arguments))};return i.for=(l,r)=>{const c=n.get(l)||n.set(l,D1(null));return c[r]||(c[r]=s(T()))},i.node=function(){return z(e,T(),i.apply(null,arguments)).valueOf()},i;function i(){return new B(t,j1.apply(null,arguments))}},z=(t,e,{type:n,template:s,values:i})=>{const{length:l}=i;r1(t,e,i,l);let{entry:r}=e;if(!r||r.template!==s||r.type!==n){const c=new t(n);e.entry=r={type:n,template:s,tag:c,wire:d1(c(s,...i))}}else r.tag(s,...i);return r.wire},r1=(t,{stack:e},n,s)=>{for(let i=0;i<s;i++){const l=n[i];l instanceof P1?n[i]=z(t,e[i]||(e[i]=T()),l):H(l)?r1(t,e[i]||(e[i]=T()),l,l.length):e[i]=null}s<e.length&&e.splice(s)};_1(B);function B(t,e){this.type=t,this.template=e.shift(),this.values=e}const P1=B,{render:o2,html:f,svg:C2}=I1(s1);function j1(){let t=[],e=0,{length:n}=arguments;for(;e<n;)t.push(arguments[e++]);return t}const R1="Links!",F1="My meta description.",W1="Eros Asteria",G1="custom-theme",U1="https://cdn.glitch.global/9e5d9ce1-1f40-47f0-a89e-c393fab34003/Drag%20Reunion%202024-0316.jpg?v=1743633222624",i1=[{url:"https://www.eventbrite.ca/e/drag-bingo-at-aok-tickets-1064953256859",text:"June 3rd - Happy Pride Month! I'll be co-hosting Drag Bingo w/ Manny Manila",img:""},{url:"mailto:eros.asteria@gmail.com",text:"Send Me A Note // Book Me",img:""},{url:"https://ko-fi.com/erosasteria",text:"Buy Me A Coffee ‧☕ ׂ 𓈒 ⋆ ۪ ",img:""},{url:"https://www.communityedition.ca/tces-one-hell-of-a-drag-show/",text:"The Community Edition: ONE HELL OF A DRAG SHOW",img:""}],q1={glitch:"",arena:"",bandcamp:"",cohost:"",dev:"",facebook:"",github:"",gitlab:"",hashnode:"",instagram:"https://www.instagram.com/eros.asteria",keybase:"",kofi:"",letterboxd:"",linkedin:"",mastodon:"",medium:"",onlyfans:"",patreon:"",pinboard:"",pinterest:"",podcast:"",soundcloud:"",spotify:"",stackoverflow:"",substack:"",twitter:"",twitch:"",tiktok:"",tumblr:"",youtube:"",email:""},g={metaTitle:R1,metaDescription:F1,name:W1,theme:G1,avatarImage:U1,links:i1,social:q1},K1=f.node`
  <title>${g.metaTitle}</title>

  <!-- OpenGraph/Social sharing -->
  <meta name="description" content="${g.metaDescription}" />
  <meta name="og:description" content="${g.metaDescription}" />
  <meta property="og:image" content="${g.avatarImage}" />
  <meta property="og:title" content="${g.metaTitle}" />
  <meta name="twitter:card" content="summary" />
  <!-- Load our custom theme -->
  <link rel="stylesheet" type="text/css" href="/styles/themes/${g.theme}.css" />
`,X1=f.node`<div>
  <div class='avatar-container'>
    <img src='${g.avatarImage}' class='avatar' alt='${g.name}' />
  </div>
  <h1>${g.name}</h1>
   <h2>
...
</div>`;function J1(t){const e=t.url?t.url.replace(/[^a-z0-9]/gi,"-").toLowerCase():"";return f`
    <li class=${e}>
      <a href=${t.url}>
